	...
	switch(modnya){
		case "profil":
			...
			kolom[modnya] = [	
				...
				{field:'nama_server',title:'Nama Server',width:250, halign:'left',align:'left'},
				{field:'nama_kecamatan',title:'Nama Kecamatan',width:250, halign:'left',align:'left'},
				{field:'alamat',title:'Alamat',width:350, halign:'left',align:'left'},
				{field:'longi',title:'Lokasi',width:350, halign:'left',align:'left',
					formatter: function(value,row,index){
						return 'Longitude : '+value+' <br> Latitude : '+row.lat;
					}
				},
				{field:'luas_wilayah',title:'Luas Wilayah',width:150, halign:'left',align:'left'},
				{field:'jml_penduduk',title:'Jml. Penduduk',width:150, halign:'left',align:'left'},
				{field:'jml_kelurahan',title:'Jml. Kelurahan',width:150, halign:'left',align:'left'},
				{field:'telp',title:'No. Tlp',width:150, halign:'left',align:'left'},
				{field:'email',title:'Email',width:150, halign:'left',align:'left'},
		...
		case "prov":
			...
			kolom[modnya] = [	
				...
				{field:'id',title:'ID',width:250, halign:'left',align:'left'},
				{field:'nama',title:'Provinsi',width:750, halign:'left',align:'left'},
		...
		case "kab_kota":
			...
			kolom[modnya] = [	
				...
				{field:'id',title:'ID ',width:250, halign:'left',align:'left'},
				{field:'nama',title:'Kab Kota',width:450, halign:'left',align:'left'},
				{field:'prov',title:'Provinsi',width:450, halign:'left',align:'left'},
		...
		case "kec":
			...
			kolom[modnya] = [	
				...
				{field:'id',title:'ID ',width:250, halign:'left',align:'left'},
				{field:'nama',title:'Kecamatan',width:350, halign:'left',align:'left'},
				{field:'prov',title:'Provinsi',width:350, halign:'left',align:'left'},
				{field:'kab_kota',title:'Kab/Kota',width:350, halign:'left',align:'left'},
		...
		case "desa":
			...
			kolom[modnya] = [	
				...
				{field:'id',title:'ID ',width:250, halign:'left',align:'left'},
				{field:'nama',title:'Desa',width:350, halign:'left',align:'left'},
				{field:'prov',title:'Provinsi',width:350, halign:'left',align:'left'},
				{field:'kab_kota',title:'Kab/Kota',width:350, halign:'left',align:'left'},
				{field:'kec',title:'Kecamatan',width:350, halign:'left',align:'left'},
		...
		case "set_server":
			judulnya = "";
			urlnya = "tbl_seting_android_server";
			fitnya = true;
			urlglobal = host+'modul/getdata/'+urlnya;
			kolom[modnya] = [	
				...
				{field:'nama_server',title:'Nama Server ',width:250, halign:'left',align:'left'},
				{field:'ip_server',title:'IP Server ',width:250, halign:'left',align:'left'},
				{field:'host',title:'HOST Server (API)',width:250, halign:'left',align:'left'},
				{field:'prov',title:'Provinsi',width:200, halign:'left',align:'left'},
				{field:'kab_kota',title:'Kab/Kota',width:300, halign:'left',align:'left'},
				{field:'kec',title:'Kecamatan',width:300, halign:'left',align:'left'},
				{field:'flag',title:'Status',width:100, halign:'left',align:'left',
					formatter: function(value,row,index){
		...
		case "pengguna":
			judulnya = "";
			urlnya = "tbl_seting_android";
			fitnya = true;
			urlglobal = host+'modul/getdata/'+urlnya;
			kolom[modnya] = [	
				
				
				{field:'imei',title:'Imei ',width:250, halign:'left',align:'left'},
				{field:'prov',title:'Provinsi',width:200, halign:'left',align:'left'},
				{field:'kab_kota',title:'Kab/Kota',width:300, halign:'left',align:'left'},
				{field:'kec',title:'Kecamatan',width:300, halign:'left',align:'left'},
				{field:'flag',title:'Status',width:100, halign:'left',align:'left',
				...
				{field:'ip',title:'Akses',width:200, halign:'left',align:'left'}
			];
		break;
		case "customer":
			judulnya = "";
			...
			kolom[modnya] = [	
				...
				{field:'nama_customer',title:'Nama Customer',width:350, halign:'left',align:'left'},
				{field:'telp_customer',title:'Telp',width:200, halign:'left',align:'left'},
				{field:'alamat_customer',title:'Alamat',width:400, halign:'left',align:'left'}
			];
		break;
		case "invoice_po":
			judulnya = "";
			...
			urlglobal = host+'modul/getdata/'+urlnya;
			frozen[modnya]=[
				{field:'kode_supplier',title:'Termin',width:120, halign:'center',align:'center',
					formatter: function(value,row,index){
						return "<a href='javascript:void(0);' class='btn btn-sm btn-danger' onclick='get_detil(\"invoice_po\","+row.id+")'>Buat Termin</a>";
					}
					
				},
				{field:'flag',title:'Status',width:120, halign:'center',align:'center',
					formatter: function(value,row,index){
						if(value=='P'){
							return "Proses Pembayaran";
						}else if(value=='G'){
							return "Deliveri Gudang";
						}else if(value=='PD'){
							return "Pending";
						}else if(value=='F'){
							return "Close";
					...
					styler: function(value,row,index){
						if(value=='C')return "background:red;color:#ffffff";
						if(value=='P')return "background:#0a9107;color:#ffffff";
						if(value=='G')return "background:#eaf5ba;color:#000000";
						if(value=='PD')return "background:yellow;color:navy;";
					}
					
				},
				{field:'no_po',title:'No PO',width:300, halign:'center',align:'center'},
				{field:'supplier',title:'Supplier',width:200, halign:'left',align:'left'},
			];
			kolom[modnya] = [
				{field:'total_qty',title:'TotalQty',width:150, halign:'right',align:'right',
					formatter: function(value,row,index){
						return NumberFormat(value) 
					}
				},
				{field:'grand_total',title:'Total Bayar',width:150, halign:'right',align:'right',
					formatter: function(value,row,index){
						return 'Rp. '+NumberFormat(value) 
					}
				},
				{field:'total_termin',title:'Total Sudah Bayar',width:150, halign:'right',align:'right',
					formatter: function(value,row,index){
						return 'Rp. '+NumberFormat(value) 
					}
				},
				{field:'sisa',title:'SisaPembayaran',width:150, halign:'right',align:'right',
					formatter: function(value,row,index){
						if(row.sisa)return 'Rp. '+NumberFormat(value) 
						else return 'Rp. '+NumberFormat(row.grand_total) 
					}
				}
		...
		case "so":
			...
			urlglobal = host+'modul/getdata/'+urlnya;
			kolom[modnya] = [	
				{field:'flag',title:'Status S.O',width:150, halign:'center',align:'center',
					formatter: function(value,row,index){
						if(value=='P'){
				...
				{field:'so_kode',title:'Kode S.O',width:250, halign:'center',align:'center'},
				{field:'create_date',title:'Tanggal S.O',width:150, halign:'center',align:'center'},
				{field:'nama_lengkap',title:'Dibuat Oleh',width:220, halign:'left',align:'left'},
				{field:'create_by',title:'Verifikasi',width:120, halign:'center',align:'center',
					formatter: function(value,row,index){
						if(row.flag=='P' || row.flag=='C'){
							return "<a href='javascript:void(0);' class='btn btn-sm btn-warning' onclick='get_ver_so("+row.id+")'>Verifikasi S.O</a>";
						}else {
							return 'S.O Closed';
						}
					}
		...
		case "so_his":
			...
			kolom[modnya] = [	
				...
				{field:'create_date',title:'Tanggal S.O',width:150, halign:'center',align:'center'},
				{field:'nama_lengkap',title:'Dibuat Oleh',width:220, halign:'left',align:'left'},
				{field:'create_by',title:'Lihat',width:120, halign:'center',align:'center',
					formatter: function(value,row,index){
						return "<a href='javascript:void(0);' class='btn btn-sm btn-warning' onclick='get_so_his("+row.id+")'>Lihat S.O</a>";
					}
				},
		...
		case "barang_keluar":
			judulnya = "";
			urlnya = "barang_keluar";
			fitnya = true;
			nowrap_nya=false;
			urlglobal = host+'modul/getdata/'+urlnya;
			frozen[modnya]=[
				{field:'id_sales',title:'Action ',width:250, halign:'center',align:'center',
					formatter: function(value,row,index){
						var html="";
						if(row.no_faktur){
							 html +="<a href='javascript:void(0);' class='btn btn-sm btn-danger' onclick='cetak(\"barang_keluar\","+row.id+")'>Cetak Faktur</a>";
						}else{
							html +="<a href='javascript:void(0);' class='btn btn-sm btn-warning' onclick='get_detil(\"barang_keluar\","+row.id_sales+")'>Buat Faktur</a>";
						}
				...
				{field:'flag_sales',title:'Status',width:120, halign:'center',align:'center',
					formatter: function(value,row,index){
						if(value=='P'){
				...
				{field:'no_invoice',title:'No Invoice',width:200, halign:'left',align:'left',
					formatter: function(value,row,index){
						return "No. "+value+' <br>tgl : '+row.tgl_invoice;
					}
				},
				{field:'no_faktur',title:'No Faktur',width:200, halign:'left',align:'left',
					formatter: function(value,row,index){
						if(value){
							return "No. "+value+' <br>tgl : '+row.tgl;
						}else{
							return "No. - <br>tgl : -";
						}
					}
			...
			kolom[modnya] = [
				{field:'total_sales',title:'Total Sales',width:150, halign:'right',align:'right',
					formatter: function(value,row,index){
						return NumberFormat(value);
					}
				},
				{field:'total_qty',title:'Total Keluar',width:150, halign:'right',align:'right',
					formatter: function(value,row,index){
						return NumberFormat(value);
					},
					styler: function(value,row,index){
						if(parseInt(value)!=parseInt(row.total_sales)){
							return "background:red;color:#ffffff";
						}
					}
				},
				{field:'nama_lengkap',title:'Diajukan Oleh',width:220, halign:'left',align:'left'},
				
			];
		break;
		case "his_barang_keluar":
			judulnya = "";
			urlnya = "his_barang_keluar";
			fitnya = true;
			nowrap_nya=false;
			urlglobal = host+'modul/getdata/'+urlnya;
			frozen[modnya]=[
		...
		case "penjualan":
			...
			urlglobal = host+'modul/getdata/'+urlnya;
			frozen[modnya]=[
				{field:'create_date',title:'Cetak',width:250, halign:'center',align:'center',
					formatter: function(value,row,index){
						return "<a href='javascript:void(0);' class='btn btn-sm btn-danger' onclick='cetak(\"penjualan\","+row.id+")'>Cetak Invoice</a> | <a href='javascript:void(0);' class='btn btn-sm btn-danger' onclick='cetak(\"label\","+row.id+")'>Cetak Label</a>";
					}
				...
				{field:'no_invoice',title:'No Invoice',width:300, halign:'left',align:'left',
					formatter: function(value,row,index){
						return "No. "+value+' <br>tgl : '+row.tgl;
					}
				},
			...
			kolom[modnya] = [
				{field:'nama_customer',title:'Customer',width:220, halign:'left',align:'left'},
				{field:'alamat_customer',title:'Alamat',width:220, halign:'left',align:'left'},
				{field:'telp_customer',title:'Telp',width:220, halign:'left',align:'left'},
				{field:'grand_total',title:'GrandTotal',width:150, halign:'right',align:'right',
					formatter: function(value,row,index){
						return "Rp. "+NumberFormat(value);
					}
				},
		...
		case "barang_masuk_sales":
			judulnya = "";
			urlnya = "barang_masuk_sales";
			fitnya = true;
			nowrap_nya=false;
			urlglobal = host+'modul/getdata/'+urlnya;
			frozen[modnya]=[
				{field:'kode_supplier',title:'Cetak',width:120, halign:'center',align:'center',
					formatter: function(value,row,index){
						return "<a href='javascript:void(0);' class='btn btn-sm btn-danger' onclick='cetak(\"barang_masuk_sales\","+row.id+")'>Cetak Faktur</a>";
					}
					
				},
				{field:'create_by',title:'Transfer Stok',width:150, halign:'center',align:'center',
					formatter: function(value,row,index){
						if(row.flag=='P'){
							return "<a href='javascript:void(0);' class='btn btn-sm btn-warning' onclick='transfer_stok("+row.id+")'>Transfer</a>";
						}else{
							return 'Berhasil Transfer Stok';
						}
					}
					
				},
				{field:'flag',title:'Status Stok',width:120, halign:'center',align:'center',
					formatter: function(value,row,index){
						if(value=='P'){
							return "In Proses";
						}else{
				...
				{field:'no_faktur',title:'No Faktur',width:300, halign:'left',align:'left',
					formatter: function(value,row,index){
						return "No. "+value+' <br>tgl : '+row.tgl;
					}
				},
		...
		case "ver_po":
			...
			urlglobal = host+'modul/getdata/'+urlnya;
			frozen[modnya]=[
				{field:'kode_supplier',title:'Verifikasi',width:120, halign:'center',align:'center',
					formatter: function(value,row,index){
						return "<a href='javascript:void(0);' class='btn btn-sm btn-danger' onclick='get_detil(\"ver_po\","+row.id+")'>Verifikasi</a>";
					}
				...
				{field:'no_po',title:'No PO',width:200, halign:'left',align:'left',
					formatter: function(value,row,index){
						return "No. "+value+' <br>tgl : '+row.tgl_po;
					}
				},
				{field:'supplier',title:'Supplier',width:250, halign:'left',align:'left'},
			];
			kolom[modnya] = [
				{field:'total_qty',title:'Total',width:150, halign:'right',align:'right',
					formatter: function(value,row,index){
					...
					styler: function(value,row,index){
						if(parseInt(value)!=parseInt(row.total_qty_po)){
							return "background:red;color:#ffffff";
						}
					}
				},
				{field:'total_qty_po',title:'Total PO',width:150, halign:'right',align:'right',
					formatter: function(value,row,index){
						return NumberFormat(value) 
					}
				},
		...
		case "barang_masuk":
			...
			frozen[modnya]=[
				{field:'kode_supplier',title:'Cetak',width:120, halign:'center',align:'center',
					formatter: function(value,row,index){
						return "<a href='javascript:void(0);' class='btn btn-sm btn-danger' onclick='cetak(\"barang_masuk\","+row.id+")'>Cetak Faktur</a>";
					}
		...
		case "price":
			judulnya = "";
			urlnya = "tbl_master_price";
			fitnya = true;
			urlglobal = host+'modul/getdata/'+urlnya;
			kolom[modnya] = [	
				
				{field:'sku',title:'SKU',width:120, halign:'center',align:'center'},
				{field:'nama_produk',title:'Nama Produk',width:350, halign:'left',align:'left'},
				{field:'kategori_barang',title:'Kategori',width:200, halign:'left',align:'left'},
				{field:'supplier',title:'Supplier',width:100, halign:'left',align:'left'},
				{field:'warna',title:'Warna',width:100, halign:'left',align:'left'},
				{field:'hpp',title:'HPP',width:120, halign:'right',align:'right',
					formatter: function(value,row,index){
						return 'Rp. '+NumberFormat(value)
					}
				},
				{field:'harga_jual',title:'Harga Jual',width:120, halign:'right',align:'right',
					formatter: function(value,row,index){
						return 'Rp. '+NumberFormat(value)
					}
				},
		...
		case "barang":
			...
			kolom[modnya] = [
				{field:'sku',title:'SKU',width:120, halign:'center',align:'center'},
				{field:'nama_produk',title:'Nama Produk',width:400, halign:'left',align:'left'},
				{field:'kategori_barang',title:'Kategori',width:200, halign:'left',align:'left'},
				{field:'supplier',title:'Supplier',width:200, halign:'left',align:'left'},
				{field:'warna',title:'Warna',width:200, halign:'left',align:'left'},
				{field:'update_date',title:'Barcode',width:150, halign:'center',align:'center',
					formatter: function(value,row,index){
						return "<img src='__repo/barcode/"+row.sku+".png' style=''>";
					}
				},
				{field:'update_by',title:'Cetak Barcode',width:150, halign:'center',align:'center',
					formatter: function(value,row,index){
						return "<a href='javascript:void(0);' class='btn btn-sm btn-danger' onclick='print_barcode(\""+row.sku+"\")'>Cetak</a>";
					}
				},
		...
		case "po":
			...
			frozen[modnya]=[
				...
				{field:'no_po',title:'No PO',width:300, halign:'center',align:'center'},
				{field:'supplier',title:'Supplier',width:400, halign:'left',align:'left'},
			];
			kolom[modnya] = [
				{field:'total_qty',title:'TotalQty',width:150, halign:'right',align:'right',
					formatter: function(value,row,index){
...
function transfer_stok(id){
	$.messager.confirm('FORDZA','Anda Yakin Transfer Stok Data Ini ?',function(re){
		if(re){
			loadingna();
			$.post(host+'modul/cruddata/transfer_stok', {id:id, 'sts_crud':'add'}, function(r){
				if(r==1){
					winLoadingClose();
					$.messager.alert('FORDZA',"Data Berhasil Transfer Ke Stok",'info');
					grid_nya.datagrid('reload');								
				}else{
					winLoadingClose();
					console.log(r)
					$.messager.alert('FORDZA',"Gagal Transfer Data",'error');
				}
			});	
		}
	});
...
function cetak_excel(mod,id){
	var params={};
	params["id"]=id;
	params["mod"]=mod;
	openWindowWithPost(host+'modul/export_excel',params);
}
function get_detil(mod,id){
	console.log(mod);
	$('#grid_nya_'+mod).hide();
	$('#detil_nya_'+mod).empty().show().addClass("loading");
	$.post(host+'modul/get_konten/'+mod, {id:id}, function(resp){
		$('#detil_nya_'+mod).show();
		$('#detil_nya_'+mod).html(resp).removeClass("loading");
	});
}
function get_so_his(id){
	$('#grid_nya_so_his').hide();
	$('#detil_nya_so_his').empty().show().addClass("loading");
	$.post(host+'modul/get_konten/so_his', {id:id}, function(resp){
		$('#detil_nya_so_his').show();
		$('#detil_nya_so_his').html(resp).removeClass("loading");
	});
}
function get_ver_so(id){
	$('#grid_nya_so').hide();
	$('#detil_nya_so').empty().show().addClass("loading");
	$.post(host+'modul/get_konten/ver_so', {id:id}, function(resp){
		$('#detil_nya_so').show();
		$('#detil_nya_so').html(resp).removeClass("loading");
	});
}
...
function get_revisi_po(id){
	$('#grid_nya_po').hide();
	$('#detil_nya_po').empty().show().addClass("loading");
	$.post(host+'modul/revisi', {id:id}, function(resp){
		$('#detil_nya_po').show();
		$('#detil_nya_po').html(resp).removeClass("loading");
	});
}
function genform(type, modulnya, submodulnya, stswindow, tabel){
	...
	switch(submodulnya){
		case "profil":table="tbl_profil";break;
		case "prov":table="cl_provinsi";break;
		case "kab_kota":table="cl_kab_kota";break;
		case "kec":table="cl_kecamatan";break;
		case "desa":table="cl_kelurahan_desa";break;
		case "pengguna":table="tbl_seting_android";break;
		case "set_server":table="tbl_seting_android_server";break;
		case "barang":table="tbl_master_barang";break;
		...
		case "penjualan":table="tbl_h_penjualan";break;
		case "barang_masuk":table="tbl_h_masuk";break;
		case "barang_masuk_sales":table="tbl_h_masuk_sales";break;
		case "ver_po":table="tbl_h_masuk";break;
		case "cl_vendor":table="cl_vendor";break;
		case "so":table="so";break;
	}
	...
	switch(type){
		...
		case "delete":
			...
			if(row){
				var id=row.id;
				if(submodulnya=='barang')id=row.sku;
				if(submodulnya=='supplier')id=row.kode_supplier;
				if(submodulnya=='warna')id=row.kode_warna;
				if(type=='edit'){
					if(submodulnya=='penjualan'){
						if(row.flag=='F'){
							$.messager.alert('FORDZA',"Maaf Data Sudah Closing",'warning');
							return false;
						}
					...
					$.post(urlpost, { 'editstatus':'edit', id:id, 'ts':table, 'submodul':submodulnya, 'bulan':row.bulan, 'tahun':row.tahun, 'id_tambahan':id_tambahan }, function(resp){
						if(stswindow == 'windowform'){
							windowForm(resp, judulwindow, lebar, tinggi);
						}else if(stswindow == 'windowpanel'){
							windowFormPanel(resp, judulwindow, lebar, tinggi);
					...
					$.messager.confirm('BSR','Anda Yakin Menghapus Data Ini ?',function(re){
						if(re){
							loadingna();
							$.post(urldelete, {id:id, 'sts_crud':'delete'}, function(r){
								if(r==1){
									winLoadingClose();
...
function tambah_row(mod,param){
	...
	switch(mod){
		...
		case "bd_masuk_sales":
			tr_table +='<tr class="tr_em" id="tm_'+idx_row+'" idx=1>';
			tr_table +='<td>';
			tr_table +='<input type="text" name="sku[]" onKeyup="this.value = this.value.toUpperCase()"  class="validasi autoo2" style="width:100%">';
			tr_table +='</td>';
			tr_table +='<td>';
			tr_table +='<input type="text" name="nama_produk[]" id="nama_produk_'+idx_row+'" class="validasi" style="width:100%">';
			tr_table +='</td>';
			tr_table +=tmp_row;
			tr_table +='<td style="text-align:right;;vertical-align:middle;"><span id="t_tot_'+idx_row+'_'+param+'"></span><input type="hidden" name="total[]" id="tot_'+idx_row+'_'+param+'" class="h_tot" style="width:100%"></td>';
			//tr_table +='<td><input type="text" name="keterangan[]" class="" style="width:100%"></td>';
		...
		case "bd_po":
			tr_table +='<tr class="tr_em" id="tm_'+idx_row+'" idx=1>';
			tr_table +='<td>';
			tr_table +='<input type="text" name="sku[]" onKeyup="this.value = this.value.toUpperCase()"  class="validasi autoo" style="width:100%">';
			tr_table +='</td>';
			tr_table +='<td>';
			tr_table +='<input type="text" name="nama_produk[]" id="nama_produk_'+idx_row+'" class="validasi" style="width:100%">';
			tr_table +='<input type="hidden" name="harga[]" id="harga_'+idx_row+'" class="validasi harga" style="width:100%">';
			tr_table +='</td>';
			tr_table +=tmp_row;
			tr_table +='<td style="text-align:right;;vertical-align:middle;"><span id="t_tot_'+idx_row+'_'+param+'"></span>';
			tr_table +='<input type="hidden" name="total[]" id="tot_'+idx_row+'_'+param+'" class="h_tot" style="width:100%">';
			tr_table +='<input type="hidden" name="total_harga[]" id="tot_harga_'+idx_row+'_'+param+'" class="h_tot_harga" style="width:100%"></td>';
			//tr_table +='<td><input type="text" name="keterangan[]" class="" style="width:100%"></td>';
			tr_table +='<td style="text-align:center;vertical-align:middle;"><a href="javascript:void(0);" class="btn btn-sm btn-danger" onclick="$(this).parents(\'tr\').first().remove();hitung_total();">-</a></td>';
			tr_table +='</tr>';
		...
		case "bd_termin":
			...
			tr_table +='<input type="hidden" name="sts_dt[]"  class="validasi" style="width:100%" value="add">';
			tr_table +='</td>';
			tr_table +='<td style="text-align:center;;vertical-align:top;">';
			tr_table +='<input type="text" name="termin_total[]" id="termin_tot_'+idx_row_termin+'_'+param+'" idx="'+idx_row_termin+'" class="angka3" style="width:150px;height:26px;">';
			tr_table +='<input type="hidden" name="t_termin_total[]" id="t_termin_total_'+idx_row_termin+'_'+param+'" idx="'+idx_row_termin+'" class="termin_total" style="width:150px;height:26px;">';
			tr_table +='</td>';
		...
		case "bd_penjualan":
			...
			tr_table +='<tr class="tr_em" id="tm_'+idx_row+'" idx=1>';
			tr_table +='<td>';
			tr_table +='<input type="text" name="sku[]" id="sku_'+idx_row+'" idx='+idx_row+' onKeyup="this.value = this.value.toUpperCase()"  class="validasi autoo2" style="width:100%">';
			tr_table +='</td>';
			tr_table +='<td>';
			tr_table +='<input type="text" name="nama_produk[]" idx='+idx_row+' id="nama_produk_'+idx_row+'" class="validasi" style="width:100%" readonly>';
			tr_table +='</td>';
			tr_table +='<td>';
			tr_table +='<select  id="cl_size_kode_'+idx_row+'" idx='+idx_row+'  name="cl_size_kode[]" class="st" style="width:80%;height:27px">';
			tr_table +=tmp_select;
			tr_table +='</select>';
			tr_table +='</td>';
			tr_table +='<td style="text-align:right;;vertical-align:middle;">';
			tr_table +='Rp. <span id="t_harga_'+idx_row+'"></span>';
			tr_table +='<input type="hidden" name="harga[]" id="harga_'+idx_row+'" idx='+idx_row+' class="" style="width:100%" readonly>';
			tr_table +='<input type="hidden" name="harga_beli[]" id="harga_beli_'+idx_row+'" idx='+idx_row+' class="" style="width:100%" readonly>';
			tr_table +='</td>';
			//tr_table +='<td>';
			//tr_table +='<input type="text" name="diskon[]" id="diskon_'+idx_row+'" idx='+idx_row+' class="angka_dis" style="width:100%;height:26px;">';
			//tr_table +='</td>';
			tr_table +='<td>';
			tr_table +='<input type="text" name="qty[]" id="qty_'+idx_row+'" idx='+idx_row+' class="validasi angka_qty total_qty" style="width:50px;height:26px;">';
			tr_table +='</td>';
			tr_table +='<td style="text-align:left;;vertical-align:middle;">';
		//	tr_table +='Rp. <span id="t_total_'+idx_row+'"></span>';
			tr_table +='<input type="text" name="total[]" id="total_'+idx_row+'" idx='+idx_row+'  class=" angka_fin validasi" style="width:200px;height:26px;">';
			tr_table +='<input type="hidden" name="t_total[]" id="t_total_'+idx_row+'" class="total" style="width:200px;height:26px;" >';
			tr_table +='</td>';
			tr_table +='<td style="text-align:center;vertical-align:middle;"><a href="javascript:void(0);" class="btn btn-sm btn-danger" onclick="$(this).parents(\'tr\').first().remove();">-</a></td>';
			tr_table +='</tr>';
		break;
	...
	if(mod=='bd_po'){
		...
		minChars: 2,
		source: function(term, response){
			$.getJSON(host+'modul/getdata/auto_katalog',{ q: term,supplier:$('#kode_supplier_'+param).val() },function(data){ response(data); });
		},
		renderItem: function (item, search){
			search = search.replace(/[-\/\\^$*+?.()|[\]{}]/g, '\\$&');
			var re = new RegExp("(" + search.split(' ').join('|') + ")", "gi");
		...
		onSelect: function(e, term, item){
			//alert('Item "'+item.data('val')+' ('+item.data('id')+')" selected by '+(e.type == 'keydown' ? 'pressing enter' : 'mouse click')+'.');
			//$('#cl_produk_id_'+idx_row).val(item.data('id'));
			$('#nama_produk_'+idx_row).val(item.data('nama'));
			$('#harga_'+idx_row).val(item.data('hpp'));
	...
	if(mod=='bd_penjualan'){
		$('.autoo2').autoComplete({
			...
			onSelect: function(e, term, item){
				//alert('Item "'+item.data('val')+' ('+item.data('id')+')" selected by '+(e.type == 'keydown' ? 'pressing enter' : 'mouse click')+'.');
				$('#nama_produk_'+idx_row).val(item.data('nama'));
				$('#harga_'+idx_row).val(item.data('harga'));
				$('#harga_beli_'+idx_row).val(item.data('hpp'));
				$('#t_harga_'+idx_row).html(NumberFormat(item.data('harga')));
		...
		$('#cl_size_kode_'+idx_row).change(function(){
			var idx=$(this).attr('idx');
	...
	*/
	$('.angka').numberbox({
		...
		//	$('#tot_'+idx+'_'+param).val(t_tot);
			$('#t_qty_'+id_size+'_'+idx+'_'+param).val(qty);
			hitung_total(idx,param);
	...
	$('.angka3').numberbox({
		...
		onChange:function(x,y){
			...
			var idx=($(this).attr('idx'));
			$('#t_termin_total_'+idx+'_'+param).val(bayar);
			hitung_total_termin();
		}
	});
	$('.angka4').numberbox({
...
function hitung_total(idx,param){
	var tot=0;
	var tot_qty=0;
	var tot_harga=0;
	var grand_total=0;
	$('.h_tot_qty_'+idx).each(function(i){
	...
	console.log(tot);
	tot_harga=(tot*parseFloat($('#harga_'+idx).val()));
	$('#t_tot_'+idx+'_'+param).html(NumberFormat(tot));
	$('#tot_'+idx+'_'+param).val(tot);
	$('#tot_harga_'+idx+'_'+param).val(tot_harga);
	
	$('.h_tot').each(function(i){
		if(!isNaN(parseInt($(this).val()))){
			var val=$(this).val();
			tot_qty=tot_qty+parseInt(val);
			
		}
	});
	//grand_total=(tot_qty*parseFloat($('#harga_'+idx).val()));
	$('#h_tot_qty').html(NumberFormat(tot_qty));
	$('#tot_qty').val(tot_qty);
	
	$('.h_tot_harga').each(function(i){
		if(!isNaN(parseInt($(this).val()))){
			var val=$(this).val();
			grand_total=grand_total+parseInt(val);
...
function hitung_total_termin(){
	var tot=0;
	$('.termin_total').each(function(i){
		var val=$(this).val();
		tot=tot+parseFloat(val);
		
	});
	$('#h_tot_termin').html(NumberFormat(tot));
	$('#total_termin').val(tot);
	if(tot > parseFloat($('.grand_total_po').val())){
		$('#row_total').css('background','red');
		$('#row_total').css('color','navy');
		
	}else{
		$('#row_total').css('background','navy');
		$('#row_total').css('color','#fff');
	}
}
...
function hitung_total_penjualan(){
	...
	$('#h_tot_harga').html(NumberFormat(tot));
	$('#grand_total').val(tot);
	
	$('.total_qty').each(function(i){
		var val=$(this).val();
		tot_qty=tot_qty+parseFloat(val);
		
	});
	$('#h_tot_qty').html(NumberFormat(tot_qty));
	$('#grand_total_qty').val(tot_qty);
}
...
function cariSku(sku,idx){
	$.post(host+'modul/getdata/get_sku',{sku:sku},function(r){
		var js=JSON.parse(r);
		if(js.msg!=0){
			$('#nama_produk_'+idx).val(js.nama_produk);
			$('#harga_'+idx).val(js.harga_jual);
			$('#t_harga_'+idx).html(NumberFormat(js.harga_jual));
		}else{
			$.messager.alert('FORDZA',"SKU Tidak Ditemukan",'error');
		}
	});
}
function tmp(mod){
	loadingna();
	$.post(host+'modul/get_konten/'+mod,function(r){
		winLoadingClose();
		windowForm(r,"Download Template",500,300);
	});
}
function upl(mod){
	loadingna();
	$.post(host+'modul/get_konten/'+mod,function(r){
		winLoadingClose();
		windowForm(r,"Import Data",500,300);
	});
}
function print_barcode(sku){
	var params={};
	params["sku"]=sku;
	$.post(host+'modul/get_konten/print_barcode',params,function(r){
		winLoadingClose();
		windowForm(r,"Cetak Barcode",500,200);
	});
	//openWindowWithPost(host+'modul/cetak_barcode',params);
}